...
int main() {
    OrdenadorBurbuja miLista;
    int opcion;

    // Precargado automático de algunos datos para no escribir todo desde cero
    ...
    do { 
        ...
        cout << " 3. Ordenar por Edad (Algoritmo Burbuja)\n";
        cout << " ---------------------------------------------\n";
        ...
        switch (opcion) {
            ...
            case 3:
                miLista.ordenar();
                cout << "\n[OK] Datos ordenados exitosamente por metodo de Burbuja.\n";
                break;
            case 4:
